...
const char* html_access_point_settings = R"rawliteral(
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
    <div class="container">
        ...
        <button class="button settings-button" onclick="toggleDropdown('globalSettingsDropdown', event)">Settings</button>
        <div id="globalSettingsDropdown" class="dropdown">
